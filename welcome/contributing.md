...
8.Look at some of the [open issues](https://github.com/codebuddies/cb-v2-scratch/issues) and identify one that sparks your interest.
...
If you see a bug in the app or have a feature request, feel free to [create a new issue](https://github.com/codebuddies/cb-v2-scratch/issues/new) on the Github repo!
...
- To work on a new feature, leave a comment on the issue saying that you're working on it. Then, you need to *create* a new branch for the issue. You can do it by typing:
  ...
  So for example, if you wanted to work on issue #29 [github.com/codebuddies/cb-v2-scratch/issues/29](https://github.com/codebuddies/cb-v2-scratch/issues/29), you should type:
...
Click on the "pull request" button by going to https://github.com/codebuddies/cb-v2-scratch/pulls and clicking on "new pull request." Next, select your branch, and submit.
...
Note: When you create a hangout in localhost:3000, a Slack notification will be sent to the #codebuddies-ops channel. This emulates what happens when you create a hangout on codebuddies.org, where a Slack announcement about the hangout will appear in the #announcements channel.
...
Once you've submitted your PR, switch to the branch [`adding-contributor`](https://github.com/codebuddies/cb-v2-scratch/tree/adding-contributor). Then, you can add yourself to both the README.md and on our About page. Keeping a separate branch for adding yourself as a contributor will alleviate most merge conflicts.
